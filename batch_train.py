...
def main():
    ...
    for i in range(0, 8, 2):
        for j in range(0, 8, 2):
            ...
            modelName = 'crossval_axialCropped_batch_' + str(i) + '_' + str(i + 1) + '_test_' + str(j) + '_' + str(j + 1) + '_val'
            trainFileName = 'crossval_axialCropped_batch_' + str(i) + '_' + str(i + 1) + '_test_' + str(j) + '_' + str(j + 1) + '_val_' + '_trainingResult'
            valFileName = 'crossval_axisalCropped_batch_' + str(i) + '_' + str(i + 1) + '_test_' + str(j) + '_' + str(j + 1) + '_val_' + '_validationResult'
